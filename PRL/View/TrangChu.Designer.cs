namespace Project_SHOE.View
{
    partial class TrangChu
    {
        ...
        private void InitializeComponent()
        {
            ...
            groupBox2.Location = new Point(18, 247);
            ...
            button6.Location = new Point(7, 388);
            button6.Margin = new Padding(4, 3, 4, 3);
            button6.Name = "button6";
            button6.Size = new Size(296, 60);
            button6.TabIndex = 5;
            button6.Text = "Quản Lí Nhân Viên";
            ...
            button5.Location = new Point(7, 308);
            button5.Margin = new Padding(4, 3, 4, 3);
            button5.Name = "button5";
            button5.Size = new Size(296, 60);
            button5.TabIndex = 4;
            button5.Text = "Quản Lí Khách Hàng";
            ...
            button4.Location = new Point(7, 230);
            button4.Margin = new Padding(4, 3, 4, 3);
            button4.Name = "button4";
            button4.Size = new Size(296, 60);
            button4.TabIndex = 3;
            button4.Text = "Quàn Lí Sản Phẩm";
            ...
            button3.TabIndex = 2;
            button3.Text = "Quản Lí Khuyến Mãi";
            ...
            button2.Size = new Size(296, 60);
            button2.TabIndex = 1;
            button2.Text = "Quản Lí Bán Hàng";
